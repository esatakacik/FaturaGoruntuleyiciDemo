						...
						<div style="border-color:#1e1e1e; border-style:solid; border-width:10px; padding:20px; ">
							...
							<div style="float:none; font-size:10pt; margin-bottom:50px; overflow:hidden; ">
								...
								<div style="float:right; overflow:hidden; width:49%; ">
									<div>
										<xsl:call-template name="Başlık">
											<xsl:with-param name="header" select="&apos;MUHASEBECİ BİLGİLERİ&apos;"/>
										</xsl:call-template>
										<div>
											<table border="0" cellpadding="5" cellspacing="0" width="100%">
												<tbody>
													<tr>
														...
														<td style="overflow:hidden; ">
															<span>
																<xsl:value-of select="//gl-bus:accountantInformation/gl-bus:accountantName"/>
															</span>
														</td>
													</tr>
													<tr>
														...
														<td style="overflow:hidden; ">
															<span>
																<xsl:value-of select="//gl-bus:accountantInformation/gl-bus:accountantContactInformation/gl-bus:accountantContactPhone/gl-bus:accountantContactPhoneNumber"/>
															</span>
														</td>
													</tr>
													<tr>
														...
														<td style="overflow:hidden; ">
															<span>
																<xsl:value-of select="//gl-bus:accountantInformation/gl-bus:accountantContactInformation/gl-bus:accountantContactFax/gl-bus:accountantContactFaxNumber"/>
															</span>
														</td>
													</tr>
													<tr>
														...
														<td style="overflow:hidden; ">
															<span>
																<xsl:value-of select="//gl-bus:accountantInformation/gl-bus:accountantContactInformation/gl-bus:accountantContactEmail/gl-bus:accountantContactEmailAddress"/>
															</span>
														</td>
													</tr>
													<tr>
														...
														<td style="overflow:hidden; ">
															<span>
																<xsl:value-of select="//gl-bus:accountantInformation/gl-bus:accountantEngagementTypeDescription"/>
															</span>
														</td>
													</tr>
												</tbody>
												...
												<xsl:for-each select="//gl-cor:accountingEntries">
													<xsl:for-each select="gl-cor:documentInfo">
														<td>
															<span>
																<xsl:choose>
																	<xsl:when test="gl-cor:entriesType='ledger'"> <xsl:text>Büyük Defter</xsl:text> </xsl:when>
																	<xsl:when test="gl-cor:entriesType='journal'"> <xsl:text>Yevmiye Defteri</xsl:text> </xsl:when>
																	<xsl:otherwise><xsl:text>Belge</xsl:text></xsl:otherwise>
																</xsl:choose>																
															</span>
														</td>
													</xsl:for-each>
