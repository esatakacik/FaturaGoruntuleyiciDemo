	...
	<xsl:template match="/">
		<html>
			...
			<body
				...
				<br/>
				<xsl:if test="//n1:Invoice/cac:BillingReference/cac:InvoiceDocumentReference/cbc:DocumentTypeCode[text()='İADE']">
					<table id="lineTable" width="800" height="100">
						<thead>
							<tr>
						...
						<tbody>
							<tr align="left" id="lineTableTr">							
								...
								<td id="lineTableTd"><span style="font-weight:bold; " align="center">&#160;&#160;&#160;&#160;&#160;Tarih</span></td>
							</tr>
							<xsl:for-each select="//n1:Invoice/cac:BillingReference/cac:InvoiceDocumentReference/cbc:DocumentTypeCode[text()='İADE']">
								<tr align="left" id="lineTableTr">
									<td id="lineTableTd">&#160;&#160;&#160;&#160;&#160;
										<xsl:value-of select="../cbc:ID"/> 
									</td>
